...
exports.BANDS_INCOME = exports.BANDS_INHERITANCE = void 0;
exports.applyBands = applyBands;
exports.sameAsStatute = sameAsStatute;
const won_1 = require("./won");
/** 과세표준에 누진세율표를 적용한다. 과세표준이 0 이하면 세액도 0. */
function applyBands(taxBase, bands) {
    ...
    return {
        ...
        rate: band.rate,
        quick: band.quick,
        tax: Math.max(0, (0, won_1.decimalProduct)(base, band.rate) - band.quick),
    };
}
/**
 ...
 */
function sameAsStatute(bands, statuteBase) {
