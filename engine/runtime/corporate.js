...
exports.CORP_LOCAL_BANDS = exports.CORP_BANDS = exports.EMPTY_CORPORATE = exports.CORP_KIND_LABEL = exports.CORP_KINDS = void 0;
exports.surtaxRate = surtaxRate;
exports.calcCorporate = calcCorporate;
const property_1 = require("./property");
const won_1 = require("./won");
exports.CORP_KINDS = ["house", "land-nonbiz", "right", "building", "land-biz"];
exports.CORP_KIND_LABEL = {
    house: "주택 (부수토지 포함) · 별장",
    "land-nonbiz": "비사업용 토지",
    right: "조합원입주권 · 분양권",
...
exports.EMPTY_CORPORATE = {
    kind: "house",
    price: 15 * won_1.억,
    cost: 10 * won_1.억,
    expenses: 0,
    unregistered: false,
    otherIncome: 1 * won_1.억,
};
/** 법인세율 — 법인세법 제55조 제1항 제1호 (2026년 1월 1일 이후 개시 사업연도) */
exports.CORP_BANDS = [
    { start: 0, base: 0, rate: 0.1 },
    { start: 2 * won_1.억, base: 20_000_000, rate: 0.2 },
    { start: 200 * won_1.억, base: 3_980_000_000, rate: 0.22 },
    { start: 3000 * won_1.억, base: 65_580_000_000, rate: 0.25 },
];
/** 법인지방소득세 — 지방세법 제103조의20 제1항 제1호 (법인세율의 1/10) */
exports.CORP_LOCAL_BANDS = [
    { start: 0, base: 0, rate: 0.01 },
    { start: 2 * won_1.억, base: 2_000_000, rate: 0.02 },
    { start: 200 * won_1.억, base: 398_000_000, rate: 0.022 },
    { start: 3000 * won_1.억, base: 6_558_000_000, rate: 0.025 },
];
/** 추가과세율 — 법인세법 제55조의2 제1항 */
function surtaxRate(kind, unregistered) {
    if (kind === "house") {
        return unregistered
    ...
    if (kind === "right")
        return { rate: 0.2, law: "법인세법 제55조의2 제1항 제4호", label: "입주권·분양권 20%" };
    return { rate: 0, law: "법인세법 제55조의2", label: "추가과세 없음" };
}
function calcCorporate(input) {
    const steps = [];
    const tips = [];
    ...
    /* ── 2. 법인세 증분 ──────────────────────────────────────── */
    const withGain = (0, property_1.applyStatute)(other + gain, exports.CORP_BANDS);
    const without = (0, property_1.applyStatute)(other, exports.CORP_BANDS);
    const corpTaxDelta = (0, won_1.truncate10)(withGain.tax - without.tax);
    steps.push({
    ...
    steps.push({
        ...
        tone: "plus",
        law: "법인세법 제55조 제1항",
        note: `과세표준 ${(0, won_1.formatWon)(other + gain)}에 대한 법인세 ${(0, won_1.formatWon)((0, won_1.truncate10)(withGain.tax))} − 양도 전 ${(0, won_1.formatWon)((0, won_1.truncate10)(without.tax))}. 2억 이하 10% · 200억 이하 20% · 3천억 이하 22% · 초과 25% (2026년~)`,
    });
    /* ── 3. 추가과세 ─────────────────────────────────────────── */
    const sr = surtaxRate(input.kind, input.unregistered);
    const surtax = (0, won_1.truncate10)(gain * sr.rate);
    steps.push({
    ...
    /* ── 4. 지방소득세 ───────────────────────────────────────── */
    const localDelta = (0, won_1.truncate10)((0, property_1.applyStatute)(other + gain, exports.CORP_LOCAL_BANDS).tax - (0, property_1.applyStatute)(other, exports.CORP_LOCAL_BANDS).tax);
    const localSurtax = (0, won_1.truncate10)(surtax * 0.1);
    ...
    if (other < 2 * won_1.억 && other + gain > 2 * won_1.억) {
        tips.push({
            level: "watch",
